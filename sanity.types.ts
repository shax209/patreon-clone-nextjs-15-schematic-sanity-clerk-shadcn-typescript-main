...
export type AllSanitySchemaTypes = SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityFileAsset | Geopoint | Slug | Message | Comment | SiteSettings | Post | SanityImageCrop | SanityImageHotspot | SanityImageAsset | SanityAssetSourceData | SanityImageMetadata;
export declare const internalGroqTypeReferenceTo: unique symbol;
// Source: ./sanity/lib/post/comments.ts
// Variable: getCommentsQuery
// Query: *[_type == "comment" && post._ref == $postId] | order(createdAt asc) {  _id,  name,  message,  createdAt}
export type GetCommentsQueryResult = Array<{
  _id: string;
  name: string | null;
  message: null;
...
// Query: *[_type == "post" && tierAccess == $tier] | order(_createdAt desc) {  ...,}
...
// Query: *[_type == "siteSettings"][0]{  ...,  _id,  siteTitle,  description,  logo,  mainHeroImage{    ...,    hotspot,    asset->{      _id,      url    }  },  callToActionText,  pricingDetails[]{    tierName,    price,    description  }}
